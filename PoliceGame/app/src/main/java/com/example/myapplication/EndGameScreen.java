...
public class EndGameScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        score_INT = this.<TextView>findViewById(R.id.scoreInt_LBL);
        score_INT.setText(" " + score);
        Button score_BTN = this.<Button>findViewById(R.id.score_BTN);
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        current_score.name = name_edit_text.getText().toString();
